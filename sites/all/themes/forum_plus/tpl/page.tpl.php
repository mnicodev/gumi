 ...
 */
 ...
 if(!$is_front && count($page['sidebar_first'])) {
	$regions_width['content']=10;
	$regions_width['sidebar_first']=2;
 }
...
<div id="page" <?php print $page_css ?>>
  ...
  <?php if ($welcome = render($page['welcome'])): ?>
    <section id="welcome" class="section-title section">
		<img src="/<?php print drupal_get_path('theme','forum_plus'); ?>/images/bg-banner.jpg"  />
	  <div class="container">
        <?php print $welcome;?>
      </div>
    </section>
